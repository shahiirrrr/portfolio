 ...
 * Data component
 *
 * This component renders the main content for the home section of the portfolio.
 * It includes:
 * - A title with the name "Shahir" and an animated hand SVG
 * - A subtitle indicating the role "Software Developer"
 * - A brief description of the developer's passion and skills
 * - A "Say Hello" button with an icon for contact
 *
 * The component uses SVG elements for visual enhancements like the waving hand
 * and the send icon on the button.
 *
 * @returns {JSX.Element} A div containing the main content for the home section
 */
const Data = () => {
  return (
    <div className="home-data">
      ...
      <p className="home-description">
        Passionate about crafting efficient and innovative solutions through
        code. Skilled in developing robust applications and dedicated to
        continuous learning in the ever-evolving world of technology.
      </p>
